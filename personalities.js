const personalities = {
    ...
    creator: {
        ...
        dialogue: {
            ...
            start: ["You can have the first turn. Call it a handicap.", "Go ahead, you start. Show me your strategy.", "I'll let you lead. It's funnier that way.", "The board is yours. Don't mess it up."],
    ...
    rival: {
        ...
        dialogue: {
            ...
            winningMove: ["And that's checkmate. Too easy!", "This is it! The final blow!", "You're finished!", "It's been fun, but I win now.", "Thanks for the game. Oh, wait, it wasn't a game. It was a slaughter."],
    ...
    sovereign: {
        ...
        dialogue: {
            ...
            aiWinByMistake: ["Your foolish choice of {move} on turn {turn} secured my victory.", "To lose on {move} at turn {turn}... how common.", "Your error on turn {turn} with {move} was all I required.", "That move, {move}, on turn {turn}, was beneath you. And you lost for it."],
